...
func (_m *Admins) Create(ctx context.Context, admin models.Administrator) (models.Administrator, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, models.Administrator) (models.Administrator, error)); ok {
		return rf(ctx, admin)
	}
...
func (_m *Admins) GetByEmail(ctx context.Context, email string) (models.Administrator, error) {
	...
	var r0 models.Administrator
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (models.Administrator, error)); ok {
		return rf(ctx, email)
	}
