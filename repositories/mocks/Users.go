...
// FollowUser provides a mock function with given fields: ctx, followedUser, followerUser
func (_m *Users) FollowUser(ctx context.Context, followedUser models.User, followerUser models.User) error {
	ret := _m.Called(ctx, followedUser, followerUser)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, models.User, models.User) error); ok {
		r0 = rf(ctx, followedUser, followerUser)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *Users) Get(ctx context.Context, req users.GetUsersRequest) (users.GetUsersResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, users.GetUsersRequest) (users.GetUsersResponse, error)); ok {
		return rf(ctx, req)
	}
...
// GetByDistance provides a mock function with given fields: ctx, req
func (_m *Users) GetByDistance(ctx context.Context, req users.GetClosestUsersRequest) (users.GetUsersResponse, error) {
	ret := _m.Called(ctx, req)
...
func (_m *Users) GetFollowed(ctx context.Context, req users.GetFollowedUsersRequest) (users.GetFollowedUsersResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, users.GetFollowedUsersRequest) (users.GetFollowedUsersResponse, error)); ok {
		return rf(ctx, req)
	}
...
func (_m *Users) GetFollowers(ctx context.Context, request users.GetUserFollowersRequest) (users.GetUserFollowersResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, users.GetUserFollowersRequest) (users.GetUserFollowersResponse, error)); ok {
